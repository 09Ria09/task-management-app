...
public class BoardControllerTest {
    ...
    public void testDeleteBoardEndpoint() throws Exception {
        ...
        List<Board> boards = Arrays.asList(board, new Board("Board 1", new ArrayList<>(), new ArrayList<>()));
    ...
    public void testRenameBoardEndpoint() throws Exception {
        List<Board> boards = List.of(new Board("Board 1", new ArrayList<>(), new ArrayList<>()));
