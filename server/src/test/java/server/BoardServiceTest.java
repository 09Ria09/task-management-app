...
public class BoardServiceTest {
    ...
    public void testGetLists(){
        ...
        service.addList(b.id, new TaskList("list1"));
        service.addList(b.id, new TaskList("list2"));
    ...
    public void testGetTasks(){
        ...
        service.addTask(b.id, l.id, new Task("a", "b"));
        assertEquals(1, service.getTasks(b.id, l.id).size());
    }
